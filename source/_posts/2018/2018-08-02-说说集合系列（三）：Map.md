...
<div align=center><img src="/img/2018-08-02-12.jpg" width="500"/></div>
<!-- more -->

# Map
&emsp;&emsp;Map接口中键和值一一映射. 可以通过键来获取值。这个接口本身也有许许多多不同的实现，所使用的结构和线程安全保障方面也是不完全相同的，所以接下来就针对每种类型做个简单的解读。
<img style="clear: both;display: block;margin:auto;" src="/img/2018-08-03-14.jpg" width="70%">
...
## 继承关系简图
<img style="clear: both;display: block;margin:auto;" src="/img/2018-08-03-15.jpg" width="50%">
